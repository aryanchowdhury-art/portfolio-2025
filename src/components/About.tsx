  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Java', level: 90, years: 2 },
        { name: 'TypeScript', level: 92, years: 1 },
        { name: 'JavaScript', level: 95, years: 2 },
    ...
    },
    {
      ...
      skills: [
        { name: 'React (Hooks)', level: 95, years: 2 },
        { name: 'Angular', level: 88, years: 1 },
    ...
    },
    {
      ...
      skills: [
        { name: 'Node.js', level: 92, years: 2 },
        { name: 'Express.js', level: 90, years: 1 },
        { name: 'MongoDB', level: 88, years: 1 },
        { name: 'RESTful APIs', level: 95, years: 2 },
        { name: 'Django', level: 85, years: 1 },
        { name: 'Flask', level: 88, years: 1 },
      ],
    },
    {
      icon: Database,
      title: 'Database & API',
      skills: [
        { name: 'SQL', level: 90, years: 1 },
        { name: 'RESTful API', level: 95, years: 2 },
        { name: 'HTTP/CRUD', level: 95, years: 2 },
      ],
    },
    {
      icon: Brain,
